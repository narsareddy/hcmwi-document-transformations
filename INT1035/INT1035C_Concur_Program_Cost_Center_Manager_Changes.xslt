...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="p.emplid">1000300146</xsl:param>
    ...
    <xsl:template match="wd:Report_Entry">
        <xsl:if
            test="$p.Role_Action = 'ADD' or (not(fn:empty(fn:index-of(wd:Current_CostCenter_Managers/wd:ID[@wd:type = 'Employee_ID'], $p.emplid))) and fn:empty(fn:index-of(wd:Previous_CostCenter_Managers/wd:ID[@wd:type = 'Employee_ID'], $p.emplid)))">
